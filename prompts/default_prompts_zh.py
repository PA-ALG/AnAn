"""Set of default Chinese prompts."""
...
DEFAULT_CHOICE_SELECT_PROMPT_TMPL = (
    "以下是一些文档的列表。每个文档旁边都有一个编号，并附有该文档的摘要。同时还提供了一个问题。\n"
    "请根据文档与问题的相关性，以相关性排序，回复你应该参考的文档编号，以及相关性得分。\n"
    "相关性得分是一个 1 到 10 之间的数字，代表你认为该文档与问题的相关程度。\n"
    "不要包括与问题无关的文档。\n"
    "参考格式如下：\n"
    "文档 1:\n<文档 1 的摘要>\n\n"
    "文档 2:\n<文档 2 的摘要>\n\n"
...
RANKGPT_RERANK_PROMPT_TMPL = (
    "搜索查询: {query}。\n根据上述 {num} 个段落与搜索查询的相关性对其进行排序。"
    "请按照相关性降序排列段落，并使用标识符进行排序。"
    "最相关的段落应排在最前面。"
    "输出格式应为 [] > []，例如: [1] > [2]。"
    "只需返回排序结果，不要说任何额外的内容或解释。"
)
