...
"""
@File    : base.py
@Time    : 27/9/2024 11:19
@Author  : Duxy
@Email   : du.xi.yang@qq.com
@Software: PyCharm
"""
from agents.react_prompt import CONTEXT_TEAM_LEADER_REACT_CHAT_SYSTEM_HEADER

"""TeamLeader agent Inspection Task.
...
class TeamLeaderAgent(AgentRunner):
    """ReAct agent.
    ...
    def __init__(
        ...
        if context:
            react_chat_formatter = ReActChatFormatter.from_defaults(
                system_header=CONTEXT_TEAM_LEADER_REACT_CHAT_SYSTEM_HEADER,
                context=context
            )
